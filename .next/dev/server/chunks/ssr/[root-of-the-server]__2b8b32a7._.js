...
const api = {
    ...
    createProduct: async (data)=>{
        ...
        const { data: response, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('products').insert([
            dbEntry
        ]).select().single();
        if (error) throw new Error(error.message);
        return {
    ...
    updateProduct: async (id, data)=>{
        ...
        const { data: response, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('products').update(dbEntry).eq('id', id).select().single();
        if (error) throw new Error(error.message);
        return {
            id: response.id,
            sku: response.sku,
    ...
    bulkCreateProducts: async (products)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('products').upsert(entries, {
            onConflict: 'sku',
    ...
    reserveInventory: async (items, performedBy)=>{
        for (const item of items){
            const { data: availableLots, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').select('*').eq('product_id', item.sku).order('expiration_date', {
                ascending: true,
                nullsFirst: false
            });
            if (error) throw new Error(error.message);
            ...
            for (const lot of availableLots){
                ...
                if (toReserve > 0) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').update({
    ...
    releaseInventory: async (items, performedBy)=>{
        for (const item of items){
            const { data: reservedLots, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').select('*').eq('product_id', item.sku).gt('quantity_reserved', 0);
            if (error) throw new Error(error.message);
            let remaining = item.quantity;
    ...
    getLocations: async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('locations').select('*');
        if (error) throw new Error(error.message);
        return data.map((loc)=>({
                id: loc.id,
    ...
    addLocation: async (data)=>{
        ...
        const { data: response, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('locations').insert([
            dbEntry
        ]).select().single();
        if (error) throw new Error(error.message);
        return {
    ...
    updateLocation: async (id, data)=>{
        ...
        dbEntry.updated_at = new Date().toISOString();
        const { data: response, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('locations').update(dbEntry).eq('id', id).select().single();
        if (error) throw new Error(error.message);
        return {
            id: response.id,
    ...
    bulkImportLocations: async (newLocations)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('locations').upsert(locationsToAdd, {
    ...
    receiveStock: async (data)=>{
        const { data: existingLots, error: selectError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').select('*').eq('product_id', data.sku).eq('warehouse_id', data.warehouseId).eq('lot_number', data.lotNumber || '');
        if (selectError) throw new Error(selectError.message);
        let finalRecord;
        if (existingLots && existingLots.length > 0) {
            const lot = existingLots[0];
            const { data: updatedLot, error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').update({
            ...
            const { data: insertedLot, error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').insert([
                {
                    product_id: data.sku,
                    warehouse_id: data.warehouseId,
    ...
    adjustStock: async (data)=>{
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').select('*').eq('product_id', data.sku).eq('warehouse_id', data.warehouseId);
    ...
    transferStock: async (data)=>{
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').select('*').eq('product_id', data.sku).eq('warehouse_id', data.fromWarehouseId);
        if (data.lotNumber) query = query.eq('lot_number', data.lotNumber);
        ...
        for (const sLot of sourceLots){
            ...
            const { data: updatedSource, error: deductError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').update({
            ...
            const { data: existingTargetLots, error: targetSelectError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').select('*').eq('product_id', data.sku).eq('warehouse_id', data.toWarehouseId).eq('lot_number', sLot.lot_number || '');
            ...
            if (existingTargetLots && existingTargetLots.length > 0) {
                ...
                const { data: updatedTarget, error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').update({
                    quantity_on_hand: limitLot.quantity_on_hand + transferQty
                }).eq('id', limitLot.id).select().single();
                if (updateError) throw new Error(updateError.message);
                lastTargetItem = updatedTarget;
            } else {
                const { data: insertedTarget, error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('inventory').insert([
                    {
                        product_id: data.sku,
...
"[project]/src/context/LocationContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const LocationProvider = ({ children })=>{
    ...
    const refreshLocations = async ()=>{
        try {
            setLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getLocations();
            setLocations(data);
            setError(null);
        } catch (err) {
    ...
    const addLocation = async (data)=>{
        try {
            setLoading(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].addLocation(data);
    ...
    const updateLocation = async (id, data)=>{
        try {
            setLoading(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].updateLocation(id, data);
            await refreshLocations();
        } catch (err) {
    ...
    const bulkImportLocations = async (newLocations)=>{
        try {
            setLoading(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].bulkImportLocations(newLocations);
            await refreshLocations();
        } catch (err) {
...
"[project]/src/services/shipstationApi.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SettingsProvider = ({ children })=>{
    ...
    const refreshSettings = async ()=>{
        try {
            ...
            const [usersData, warehousesData, channelsData, systemSettingsData] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getUsers(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getWarehouses(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getChannels(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getSystemSettings()
            ]);
            setUsers(usersData);
                ...
                if (channel.isEnabled && channel.syncInventory) {
                    try {
                        ...
                        if (channel.channel === 'ShipStation' && channel.apiKey && channel.apiSecret) {
                            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$shipstationApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shipstationApi"].syncInventory(channel.apiKey, channel.apiSecret);
                        }
    ...
    const addUser = async (data)=>{
        try {
            setLoading(true);
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].addUser(data);
    ...
    const updateUser = async (id, data)=>{
        try {
            setLoading(true);
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].updateUser(id, data);
            await refreshSettings();
        } catch (err) {
    ...
    const addWarehouse = async (data)=>{
        try {
            setLoading(true);
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].addWarehouse(data);
            await refreshSettings();
        } catch (err) {
    ...
    const updateWarehouse = async (id, data)=>{
        try {
            setLoading(true);
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].updateWarehouse(id, data);
            await refreshSettings();
        } catch (err) {
    ...
    const updateSystemSettings = async (data)=>{
        try {
            setLoading(true);
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].updateSystemSettings(data);
            await refreshSettings();
        } catch (err) {
...
const ProductProvider = ({ children })=>{
    ...
    const [inventoryLocations] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initialInventory);
    const [bundleComponents, setBundleComponents] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initialBundleComponents);
    const [cogsHistory, setCogsHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initialCOGSHistory);
    const [activityLogs, setActivityLogs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initialActivityLogs);
    const fetchProducts = async ()=>{
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getProducts();
            setProducts(data);
        } catch (err) {
    ...
    const addProduct = async (data)=>{
        const newProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].createProduct(data);
        await fetchProducts();
        return newProduct;
    };
    const updateProduct = async (id, data)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].updateProduct(id, data);
        await fetchProducts();
    };
    const bulkImportProducts = async (newProducts)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].bulkCreateProducts(newProducts);
        await fetchProducts();
    };
...
"[project]/src/context/InventoryContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const InventoryProvider = ({ children })=>{
    ...
    const refreshInventory = async ()=>{
        try {
            ...
            const [invData, auditData, movementData, snapshotData] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getInventory(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getAuditLogs(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getInventoryMovements(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getDailySnapshots()
            ]);
    ...
    const receiveStock = async (data)=>{
        try {
            setLoading(true);
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].receiveStock(data);
    ...
    const adjustStock = async (data)=>{
        try {
            setLoading(true);
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].adjustStock(data);
            await refreshInventory();
        } catch (err) {
    ...
    const transferStock = async (data)=>{
        try {
            setLoading(true);
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].transferStock(data);
            await refreshInventory();
        } catch (err) {
    ...
    const reverseMovement = async (movementId)=>{
        try {
            setLoading(true);
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].reverseMovement(movementId);
            await refreshInventory();
        } catch (err) {
...
"[project]/src/services/ordersApi.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ordersApi = {
    getOrders: async ()=>{
        const { data: dbOrders, error: ordersError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('orders').select(`
                *,
                order_items (*)
            `).order('order_date', {
            ascending: false
    ...
    getOrderById: async (id)=>{
        const { data: dbOrder, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('orders').select('*, order_items(*)').eq('id', id).single();
    ...
    createB2BOrder: async (data)=>{
        ...
        const { error: itemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('order_items').insert(orderItemsEntries);
    ...
    batchCreateOrders: async (orders)=>{
        ...
        // Upsert orders
        const { error: ordersError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('orders').upsert(orderEntries, {
            onConflict: 'id',
            ignoreDuplicates: true
        });
        if (ordersError) throw new Error(ordersError.message);
        ...
        if (itemEntries.length > 0) {
            const { error: itemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('order_items').insert(itemEntries);
            if (itemsError) throw new Error(itemsError.message);
        }
    },
    updateOrderStatus: async (orderId, status, performedBy, notes)=>{
        ...
        const { error: orderError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('orders').update(updateData).eq('id', orderId);
        if (orderError) throw new Error(orderError.message);
        if (status === 'Packed' || status === 'Shipped') {
            const { error: itemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('order_items').update({
                pick_status: 'Picked'
            }).eq('order_id', orderId);
            if (itemsError) throw new Error(itemsError.message);
        }
    ...
    allocateInventory: async (orderId, performedBy)=>{
        ...
        const inventory = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getInventory();
        ...
        for (const item of order.items){
            ...
            if (targetLot) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('order_items').update({
...
const OrderProvider = ({ children })=>{
    ...
    const fetchOrders = async ()=>{
        ...
        setError(null);
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$ordersApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ordersApi"].getOrders();
            setOrders(data);
        } catch (err) {
    ...
    const updateOrderStatus = async (orderId, status, performedBy, notes)=>{
        ...
        setError(null);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$ordersApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ordersApi"].updateOrderStatus(orderId, status, performedBy, notes);
            await fetchOrders();
        } catch (err) {
    ...
    const allocateOrderInventory = async (orderId, performedBy)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$ordersApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ordersApi"].allocateInventory(orderId, performedBy);
            await fetchOrders();
        } catch (err) {
    ...
    const syncShipStationOrders = async ()=>{
        ...
        try {
            ...
            if (toAdd.length > 0) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$ordersApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ordersApi"].batchCreateOrders(toAdd);
...
function Providers({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$LocationContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LocationProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$SettingsContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SettingsProvider"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$ToastContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ToastProvider"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$ProductContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProductProvider"], {
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$InventoryContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["InventoryProvider"], {
...
const Layout = ({ children })=>{
    ...
    const toggleCollapsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        setCollapsed((prev)=>{
            const next = !prev;
            try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2b8b32a7._.js.map